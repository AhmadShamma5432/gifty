...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('base', '0007_remove_category_language_brand_city'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favorites_product', to='base.product')),
